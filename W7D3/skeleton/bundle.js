...
var GiphysIndex = function (_React$Component) {
  ...
  function GiphysIndex(props) {
    ...
    return _possibleConstructorReturn(this, (GiphysIndex.__proto__ || Object.getPrototypeOf(GiphysIndex)).call(this, props));
  }
  ...
  _createClass(GiphysIndex, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        null,
        this.props.giphys.map(function (el, idx) {
...
var giphysIndexItem = function giphysIndexItem(props) {
  ...
  return _react2.default.createElement(
    ...
    null,
    props.title,
    _react2.default.createElement("iframe", { src: props.url, width: "200", height: "200" })
  );
};
...
var GiphysSearch = function (_React$Component) {
  ...
  function GiphysSearch(props) {
    ...
    _this.state = { giphys: props.giphys, searchTerm: "" };
    return _this;
  }
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleChange(e) {
      ...
      this.props.fetchSearchGiphys(searchTerm).then(this.setState({ giphys: this.props.giphys, searchTerm: searchTerm }), console.log(this.props.giphys));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { type: 'text', value: searchTerm, onChange: function onChange(e) {
            return _this2.handleChange(e);
          } }),
        _react2.default.createElement(_giphys_index2.default, this.state)
      );
    }
  }]);
...
var giphyReducer = function giphyReducer() {
  var oldState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initalState;
